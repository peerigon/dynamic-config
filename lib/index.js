...
dynamicConfig.getEnv = function() {
    return argv.env || argv.ENV || process.env.env || process.env.ENV || process.env.NODE_ENV || process.env[dynamicConfig.options.customEnv] || dynamicConfig.options.defaultEnv;
};
